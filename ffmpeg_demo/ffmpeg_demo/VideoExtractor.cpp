...
//参考雷神博客  http://blog.csdn.net/leixiaohua1020/article/details/14215391

int VideoExtractor::execute(int agrc, char * agrv[]){
	...
	//uint8_t *writeBuffer = (uint8_t *)malloc(sizeof(uint8_t) * pCodecCtx->width * pCodecCtx->height);
